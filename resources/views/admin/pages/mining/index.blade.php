                                            ...
                                            <td>
                                                <small>
                                                    ...
                                                    Running Status: @if($row->running_status == 'start')
                                                        <img style="width: 50px; height: 50px; border-radius: 50%" src="{{asset('app/img/running.gif')}}">
                                                    @else
                                                        <img style="width: 50px; height: 50px; border-radius: 50%" src="{{asset('app/img/stop.png')}}">
                                                    @endif
                                                </small>
                                            </td>
                                        </tr>
