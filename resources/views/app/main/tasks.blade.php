...
<head>
  ...
  <script src="https://cdn.jsdelivr.net/npm/toastify-js" type="56077a7579562028dda5a9c8-text/javascript"></script>
  ...
  <div class="page-wraper">
        ...
        <div class="container">
          <div class="header-content">
            ...
            <div class="mid-content">
              <h5 class="mb-0">Reward Missions</h5>
            </div>
    ...
    <div class="sidebar">
      ...
      <ul class="nav navbar-nav">
        ...
        <li><a class="nav-link" onclick="if (!window.__cfRLUnblockHandlers) return false; navigate('/');" data-cf-modified-56077a7579562028dda5a9c8-="">
        ...
        <li><a class="nav-link" onclick="if (!window.__cfRLUnblockHandlers) return false; navigate('/home/team');" data-cf-modified-56077a7579562028dda5a9c8-="">
        ...
        <li><a class="nav-link" onclick="if (!window.__cfRLUnblockHandlers) return false; navigate('/home/products');" data-cf-modified-56077a7579562028dda5a9c8-="">
        ...
        <li><a class="nav-link" onclick="if (!window.__cfRLUnblockHandlers) return false; navigate('/home/notifications');" data-cf-modified-56077a7579562028dda5a9c8-="">
        ...
        <li><a class="nav-link" onclick="if (!window.__cfRLUnblockHandlers) return false; navigate('/home/profile');" data-cf-modified-56077a7579562028dda5a9c8-="">
        ...
        <li><a class="nav-link" onclick="if (!window.__cfRLUnblockHandlers) return false; navigate('/home/help');" data-cf-modified-56077a7579562028dda5a9c8-="">
            <span class="dz-icon bg-skyblue light">
              <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="18" height="18" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                  <rect x="0" y="0" width="24" height="24" />
    ...
    <style>
      ...
      .header {
        ...
        box-shadow: 0 4px 20px rgba(17, 90, 75, 0.3);
      }
      ...
      .btn-mission {
        ...
        font-size: 14px;
        font-weight: 500;
        box-shadow: 0 3px 10px rgba(17, 90, 75, 0.2);
        transition: all 0.3s ease;
      }

      .btn-mission:hover {
        transform: translateY(-2px);
        box-shadow: 0 5px 15px rgba(17, 90, 75, 0.3);
      }
        ...
        <div class="mission-container">
          <div class="mission-card">
            <div class="mission-header">
              ...
              <div class="mission-title" style="font-size:12px">
                Reach <strong>₱1,000</strong> team recharge & get
            ...
            <div class="mission-progress">
              <div class="progress-text">
                Progress:
                <span class="progress-count">₱0/₱1,000</span>
                <br>
                Remaining: 100%
              </div>

              <button class="btn-mission" onclick="if (!window.__cfRLUnblockHandlers) return false; check_invites('1000', '50')" data-cf-modified-56077a7579562028dda5a9c8-="">
                Claim
              </button>
            </div>
          </div>
          <div class="mission-card">
            <div class="mission-header">
              ...
              <div class="mission-title" style="font-size:12px">
                Reach <strong>₱5,000</strong> team recharge & get
            ...
            <div class="mission-progress">
              <div class="progress-text">
                Progress:
                <span class="progress-count">₱0/₱5,000</span>
                <br>
                Remaining: 100%
              </div>

              <button class="btn-mission" onclick="if (!window.__cfRLUnblockHandlers) return false; check_invites('5000', '250')" data-cf-modified-56077a7579562028dda5a9c8-="">
                Claim
              </button>
            </div>
          </div>
          <div class="mission-card">
            <div class="mission-header">
              ...
              <div class="mission-title" style="font-size:12px">
                Reach <strong>₱7,000</strong> team recharge & get
            ...
            <div class="mission-progress">
              <div class="progress-text">
                Progress:
                <span class="progress-count">₱0/₱7,000</span>
                <br>
                Remaining: 100%
              </div>

              <button class="btn-mission" onclick="if (!window.__cfRLUnblockHandlers) return false; check_invites('7000', '500')" data-cf-modified-56077a7579562028dda5a9c8-="">
                Claim
              </button>
            </div>
          </div>
          <div class="mission-card">
            <div class="mission-header">
              ...
              <div class="mission-title" style="font-size:12px">
                Reach <strong>₱10,000</strong> team recharge & get
                <span class="reward-amount">₱1000</span>
              </div>
            </div>
            ...
            <div class="mission-progress">
              <div class="progress-text">
                Progress:
                <span class="progress-count">₱0/₱10,000</span>
                <br>
                Remaining: 100%
              </div>

              <button class="btn-mission" onclick="if (!window.__cfRLUnblockHandlers) return false; check_invites('10000', '1000')" data-cf-modified-56077a7579562028dda5a9c8-="">
                Claim
              </button>
            </div>
          </div>
          <div class="mission-card">
            <div class="mission-header">
              ...
              <div class="mission-title" style="font-size:12px">
                Reach <strong>₱50,000</strong> team recharge & get
                <span class="reward-amount">₱3000</span>
              </div>
            </div>
            ...
            <div class="mission-progress">
              <div class="progress-text">
                Progress:
                <span class="progress-count">₱0/₱50,000</span>
                <br>
                Remaining: 100%
              </div>

              <button class="btn-mission" onclick="if (!window.__cfRLUnblockHandlers) return false; check_invites('50000', '3000')" data-cf-modified-56077a7579562028dda5a9c8-="">
                Claim
              </button>
            </div>
          </div>
          <div class="mission-card">
            <div class="mission-header">
              ...
              <div class="mission-title" style="font-size:12px">
                Reach <strong>₱100,000</strong> team recharge & get
                <span class="reward-amount">₱7000</span>
              </div>
            </div>
            ...
            <div class="mission-progress">
              <div class="progress-text">
                Progress:
                <span class="progress-count">₱0/₱100,000</span>
                <br>
                Remaining: 100%
              </div>

              <button class="btn-mission" onclick="if (!window.__cfRLUnblockHandlers) return false; check_invites('100000', '7000')" data-cf-modified-56077a7579562028dda5a9c8-="">
                Claim
              </button>
            </div>
          </div>
    ...
    <div class="title-bar mt-3">
      <p class="backbutton" onclick="window.history.back();" data-cf-modified-56077a7579562028dda5a9c8-="">
    ...
    <script type="text/javascript">
      function check_invites(required, amount) {
        $.get("/home/check_mission", {
          value: required,
          name: amount
        }, (response) => {
...
***********************************-->
  ...
  <script src="/assets/app/js/jquery.js" type="56077a7579562028dda5a9c8-text/javascript"></script>
  <script src="/assets/app/vendor/bootstrap/js/bootstrap.bundle.min.js" type="56077a7579562028dda5a9c8-text/javascript"></script>
  <script src="/assets/app/js/settings.js" type="56077a7579562028dda5a9c8-text/javascript"></script>
  <script src="/assets/app/js/custom.js?v=45" type="56077a7579562028dda5a9c8-text/javascript"></script>
  <script src="/assets/app/js/dz.carousel.js" type="56077a7579562028dda5a9c8-text/javascript"></script>
  <script src="/assets/app/vendor/swiper/swiper-bundle.min.js" type="56077a7579562028dda5a9c8-text/javascript"></script>
 ...
 position: fixed;
  ...
  <script type="text/javascript">
    ...
    function navigate(path, complete = true) {
      ...
      //     window.navRequestId++;
      //     const currentId = window.navRequestId;

      //     document.body.classList.add("content-updating");

      //     setTimeout(() => {
      //         if (currentId !== window.navRequestId) return;

      //         staleWhileRevalidate(path, function (data) {
      //             if (currentId !== window.navRequestId) return;

      //             try {
      //                 if (complete) {
      //                     loadFromCache(data, complete, path);
      //                     window.scrollTo(0, 0); 
      //                 } else {
      //                     const container = document.querySelector("#innerBody");
      //                     if (container) {
      ...
      //                 const pageHasContent = document.querySelector("#innerBody")?.innerText.trim().length > 0;

      //                 if (!pageHasContent) {
      //                     console.warn("Navigation succeeded but page content is empty.");
      //                 }
      //             } catch (err) {
      ...
      //             document.body.classList.remove("content-updating");
      //         });
      //     }, 200); 
    }
  ...
  <script src="/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="56077a7579562028dda5a9c8-|49" defer></script>
</body>
